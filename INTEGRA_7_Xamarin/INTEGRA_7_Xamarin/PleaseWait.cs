    ...
    public partial class UIHandler
    {
        ...
        public void ShowPleaseWaitPage(WaitingFor waitingFor, CurrentPage continueTo, Object deviceSpecifics)
        {
            ...
            if (!PleaseWait_IsCreated)
            {
                ...
                SetFontSizes(PleaseWait_StackLayout);
            ...
            PleaseWait_Init();
            needsToSetFontSizes = NeedsToSetFontSizes.PLEASEWAIT;
        }
        ...
        private void TryConnectViaPreferredConnection()
        {
            ...
            {
                commonState.Midi.Init(mainPage, preferredConnection, mainPage.MainPage_Device, 0, 0);
            }
            else
            {
