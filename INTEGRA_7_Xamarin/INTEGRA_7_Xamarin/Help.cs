...
namespace INTEGRA_7_Xamarin
{
    ...
    class Help
    {
        ...
        private void Init()
        {
            ...
            mainPageImages.Add("_pcm_d_01.png");
            mainPageImages.Add("_sn_a_01.png");
            mainPageImages.Add("_sns_01.png");
            mainPageImages.Add("_sn_d_01.png");
    ...
    class HelpItem
    {
        ...
        public HelpItem Show()
        {
            ...
            if (!String.IsNullOrEmpty(HeadingImage))
            {
                ...
                {
                    Help.imgEditToneImage.Source = ImageSource.FromResource("missingimage.png");
                }
            }
            else
            {
